  ...
  useEffect(() => {
    ...
    const fetchUsers = async () => {
        ...
        try {
            ...
            console.log('made it here: ' + authUser.attributes.sub)

            //const results = await DataStore.query(User, u => u.sub("eq", authUser.attributes.sub));
            const results = await DataStore.query(User);
            
            //const results = await DataStore.query(User, u => u.sub("eq", sub));
            ...
            //console.log('setting the state variable: ' + nameresult)
